...
public class ProgrammingProject1 {
    ...
    /*
    Given subsets A and B of a set with n elements, use an array of booleans
    to ï¬�nd A, A âˆª B, A âˆ© B, A âˆ’ B, and A âŠ• B.
    */
   ...
   printBoolArray(xOr);
    ...
    /*
    Given multi-sets A and B from the same universal set, ï¬�nd
    A âˆª B, A âˆ© B, Aâˆ’ B, and A+ B
    */
